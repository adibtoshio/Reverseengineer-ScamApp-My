...
class RoundRectDrawableWithShadow extends Drawable {
  ...
  private void b(Rect paramRect) {
    float f = this.k * 1.5F;
    this.g.set(paramRect.left + this.k, paramRect.top + f, paramRect.right - this.k, paramRect.bottom - f);
    f();
  }
  ...
  private void f() {
    ...
    paint.setShader((Shader)new LinearGradient(0.0F, f1 + f2, 0.0F, f3 - f4, new int[] { i, j, k }, new float[] { 0.0F, 0.5F, 1.0F }, tileMode));
    this.f.setAntiAlias(false);
  }
  ...
  public boolean getPadding(Rect paramRect) {
    int i = (int)Math.ceil(a(this.k, this.h, this.q));
    int j = (int)Math.ceil(b(this.k, this.h, this.q));
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\RoundRectDrawableWithShadow.class
