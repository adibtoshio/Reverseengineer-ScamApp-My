...
public class FloatButton extends ImageView {
  ...
  private void a(Context paramContext) {
    ...
    this.f = new RippleHelper((View)this.b);
    FrameLayout.LayoutParams layoutParams1 = new FrameLayout.LayoutParams(a(64.0F), a(64.0F));
    frameLayout.addView((View)this.d, (ViewGroup.LayoutParams)layoutParams2);
    this.d.addView((View)this.b, (ViewGroup.LayoutParams)layoutParams1);
    this.d.setRadius(a(32.0F));
    this.a = new PopupWindow(-2, -2);
    this.a.setContentView((View)frameLayout);
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\FloatButton.class
