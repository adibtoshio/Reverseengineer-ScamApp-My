...
public class PageView extends ViewGroup {
  ...
  private static final Comparator<ItemInfo> b = new Comparator<ItemInfo>() {
      public int compare(PageView.ItemInfo param1ItemInfo1, PageView.ItemInfo param1ItemInfo2) {
  ...
  private final ArrayList<ItemInfo> e = new ArrayList<ItemInfo>();
  ...
  private int a(int paramInt1, float paramFloat, int paramInt2, int paramInt3) {
    ...
    paramInt2 = paramInt1;
    if (this.e.size() > 0) {
      ItemInfo itemInfo1 = this.e.get(0);
  ...
  private void a(ItemInfo paramItemInfo1, int paramInt, ItemInfo paramItemInfo2) {
    ...
    if (paramItemInfo2 != null) {
      ...
      if (i < paramItemInfo1.b) {
        ...
        i++;
        int n = 0;
        while (i <= paramItemInfo1.b && n < this.e.size()) {
          float f;
          int i1;
          while (true) {
            paramItemInfo2 = this.e.get(n);
            i1 = i;
            f = f1;
    ...
    float f1 = f3;
    while (j >= 0) {
      paramItemInfo2 = this.e.get(j);
      while (i > paramItemInfo2.b) {
        f1 -= this.i.getPageWidth(i) + f2;
        i--;
      } 
  ...
  private void a(boolean paramBoolean) {
    ...
    if (i) {
      ...
      int k = getScrollX();
      int m = getScrollY();
      int n = this.n.getCurrX();
      int i1 = this.n.getCurrY();
      if (k != n || m != i1) {
        scrollTo(n, i1);
        if (n != k)
          c(n); 
  ...
  private boolean b(float paramFloat) {
    ...
    int i = this.e.size();
    boolean bool = true;
    ItemInfo itemInfo2 = arrayList.get(i - 1);
    if (itemInfo1.b != 0) {
  ...
  private ItemInfo j() {
    ...
    float f4 = 0.0F;
    while (i < this.e.size()) {
      ItemInfo itemInfo2 = this.e.get(i);
      int k = i;
  ...
  void a(int paramInt1, int paramInt2, int paramInt3) {
    ...
    this.n.startScroll(i, j, k, paramInt2, paramInt1);
  ...
  void a(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2) {
    ...
    paramInt1 = this.A;
    if (i > this.j + paramInt1 || i < this.j - paramInt1)
  ...
  void b() {
    ...
    Object object2;
    int k;
    int i2 = this.i.getCount();
    this.h = i2;
    if (this.e.size() < this.A * 2 + 1 && this.e.size() < i2) {
      j = 1;
    } else {
      j = 0;
    } 
    ...
    m = 0;
    while (n < this.e.size()) {
      ItemInfo itemInfo = this.e.get(n);
      int i6 = this.i.getItemPosition(itemInfo.a);
      if (i6 == -1) {
        int i7 = n;
      ...
      if (i6 == -2) {
        ...
        if (this.j == itemInfo.b) {
          i = Math.max(0, Math.min(this.j, i2 - 1));
          k = b;
          n = i7;
        } 
      } else {
  ...
  public void computeScroll() {
    if (!this.n.isFinished() && this.n.computeScrollOffset()) {
      int i = getScrollX();
      int j = getScrollY();
      int k = this.n.getCurrX();
      int m = this.n.getCurrY();
      if (i != k || j != m) {
        scrollTo(k, m);
        if (!c(k)) {
          this.n.abortAnimation();
  ...
  public void draw(Canvas paramCanvas) {
    ...
    int j = 0;
    int i = 0;
    if (k == 0 || (k == 1 && this.i != null && this.i.getCount() > 1)) {
      if (!this.S.isFinished()) {
        j = paramCanvas.save();
        i = getHeight() - getPaddingTop() - getPaddingBottom();
        k = getWidth();
        paramCanvas.rotate(270.0F);
        paramCanvas.translate((-i + getPaddingTop()), this.t * k);
        this.S.setSize(i, k);
        i = false | this.S.draw(paramCanvas);
      ...
      if (!this.T.isFinished()) {
        ...
        paramCanvas.translate(-getPaddingTop(), -(this.u + 1.0F) * j);
        this.T.setSize(m - n - i1, j);
        bool = i | this.T.draw(paramCanvas);
  ...
  protected void onDraw(Canvas paramCanvas) {
    ...
    if (this.p > 0 && this.q != null && this.e.size() > 0 && this.i != null) {
      ...
      int n = this.e.size();
      int i = itemInfo.b;
      int i1 = ((ItemInfo)this.e.get(n - 1)).b;
      while (i < i1) {
        float f;
        ItemInfo itemInfo1;
        while (i > itemInfo.b && j < n) {
          ArrayList<ItemInfo> arrayList1 = this.e;
        ...
        if (i == itemInfo1.b) {
          ...
          f1 = itemInfo1.e;
          float f4 = itemInfo1.d;
          f = (f + f5) * f3;
          f1 = f1 + f4 + f2;
        } else {
          float f4 = this.i.getPageWidth(i);
          f = (f1 + f4) * f3;
          f1 += f4 + f2;
        } 
        if (this.p + f > k) {
    ...
    if (i != 0) {
      if (i != 2) {
        ...
        if (i != -1) {
          ...
          if (f1 != 0.0F && !a(this.G, f1) && a((View)this, false, (int)f1, (int)f2, (int)f3)) {
            this.G = f2;
            this.H = f3;
            this.C = true;
            return false;
  ...
  private class PagerObserver extends DataSetObserver {
    private PagerObserver(PageView this$0) {}
  ...
  public static class SavedState extends View.BaseSavedState {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
        public PageView.SavedState createFromParcel(Parcel param2Parcel) {
          return new PageView.SavedState(param2Parcel);
        }
        
        public PageView.SavedState[] newArray(int param2Int) {
          return new PageView.SavedState[param2Int];
        }
      };
  ...
  static final class null implements Parcelable.Creator<SavedState> {
    public PageView.SavedState createFromParcel(Parcel param1Parcel) {
      return new PageView.SavedState(param1Parcel);
    }
    
    public PageView.SavedState[] newArray(int param1Int) {
      return new PageView.SavedState[param1Int];
    }
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\PageView.class
