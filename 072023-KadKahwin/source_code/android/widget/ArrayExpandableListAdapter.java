...
public class ArrayExpandableListAdapter extends BaseExpandableListAdapter {
  ...
  public ArrayExpandableListAdapter(Context paramContext) {
    this(paramContext, new ArrayList<String>(), 17367046, new ArrayList<List<String>>(), 17367046);
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup) {
    ...
    ((TextView)view).setText(((List<CharSequence>)this.b.get(paramInt1)).get(paramInt2));
    return view;
  }
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup) {
    ...
    ((TextView)view).setText(this.c.get(paramInt));
    return view;
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\ArrayExpandableListAdapter.class
