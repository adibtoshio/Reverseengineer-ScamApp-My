...
public class ArrayListAdapter<T> extends BaseAdapter implements Filterable {
  ...
  public ArrayListAdapter(Context paramContext) {
    a(paramContext, 17367043, 0, new ArrayList<T>());
  }
  
  public ArrayListAdapter(Context paramContext, int paramInt) {
    a(paramContext, paramInt, 0, new ArrayList<T>());
  }
  
  public ArrayListAdapter(Context paramContext, int paramInt1, int paramInt2) {
    a(paramContext, paramInt1, paramInt2, new ArrayList<T>());
  }
  ...
  private View a(int paramInt1, View paramView, ViewGroup paramViewGroup, int paramInt2) {
    ...
    try {
      ...
      if (paramViewGroup instanceof CharSequence) {
        charSequence = (CharSequence)paramViewGroup;
  ...
  private void a(Context paramContext, int paramInt1, int paramInt2, List<T> paramList) {
    ...
    this.d = paramInt1;
    this.c = paramInt1;
    this.a = new ArrayList<T>(paramList);
    this.e = paramInt2;
  }
  
  public static ArrayListAdapter<CharSequence> createFromResource(Context paramContext, int paramInt1, int paramInt2) {
    return new ArrayListAdapter<CharSequence>(paramContext, paramInt2, paramContext.getResources().getTextArray(paramInt1));
  }
  ...
  private class ArrayFilter extends Filter {
    ...
    protected Filter.FilterResults performFiltering(CharSequence param1CharSequence) {
      ...
      if (luaException == null || luaException.length() == 0)
        synchronized (ArrayListAdapter.b(this.a)) {
      ...
      null = luaException.toString().toLowerCase();
      synchronized (ArrayListAdapter.b(this.a)) {
        ArrayList<Object> arrayList = new ArrayList(ArrayListAdapter.a(this.a));
        int j = arrayList.size();
        null = new ArrayList();
        while (i < j) {
          Object object = arrayList.get(i);
          if (object.toString().toLowerCase().contains(null))
            null.add(object); 
          i++;
        } 
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\ArrayListAdapter.class
