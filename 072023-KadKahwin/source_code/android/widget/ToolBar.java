...
public class ToolBar extends LinearLayout {
  ...
  private void a(Context paramContext) {
    ...
    super.addView((View)this.c, (ViewGroup.LayoutParams)layoutParams);
    this.d = new ImageView(paramContext);
    this.d.setScaleType(ImageView.ScaleType.FIT_CENTER);
    this.d.setImageResource(2130771968);
    this.d.setVisibility(8);
    super.addView((View)this.d, (ViewGroup.LayoutParams)layoutParams);
    LinearLayout linearLayout = new LinearLayout(paramContext);
    int i = a(1.0F);
    linearLayout.setPadding(i * 4, i, i, i);
    linearLayout.setOrientation(1);
    linearLayout.setGravity(17);
    super.addView((View)linearLayout, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, this.l, 1.0F));
    this.a = new TextView(paramContext);
    this.a.setTextSize(1, 20.0F);
    this.a.setSingleLine(true);
    this.a.setTypeface(Typeface.DEFAULT_BOLD);
    linearLayout.addView((View)this.a, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, a(26.0F)));
    this.b = new TextView(paramContext);
    this.b.setTextSize(1, 14.0F);
    this.b.setSingleLine(true);
    this.b.setVisibility(8);
    linearLayout.addView((View)this.b, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, a(20.0F)));
    this.f = new LinearLayout(paramContext);
    super.addView((View)this.f, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-2, this.l));
    this.e = new ImageView(paramContext);
    this.e.setScaleType(ImageView.ScaleType.FIT_CENTER);
    this.e.setVisibility(8);
    super.addView((View)this.e, (ViewGroup.LayoutParams)layoutParams);
    new RippleHelper((View)this.c);
    new RippleHelper((View)this.e);
    ...
    this.g = new PopupMenu(getContext(), (View)this.e);
    this.g.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener(this) {
          public boolean onMenuItemClick(MenuItem param1MenuItem) {
            return (ToolBar.d(this.a) != null) ? ToolBar.d(this.a).onMenuItemClick(param1MenuItem) : false;
          }
        });
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\ToolBar.class
