...
public class PullingLayout extends RelativeLayout {
  ...
  private void a(int paramInt) {
    ...
    switch (this.b) {
      ...
      case 3:
        ...
        view2 = this.u;
        view2.startAnimation((Animation)this.m);
        return;
      case 2:
      ...
      case 1:
        ...
        view1 = this.p;
        view1.startAnimation((Animation)this.m);
        return;
      case 0:
        break;
    } 
  ...
  private void a(Context paramContext) {
    ...
    super.addView((View)this.o, (ViewGroup.LayoutParams)new RelativeLayout.LayoutParams(-1, -1));
    this.z = new FrameLayout(this.E);
    super.addView((View)this.z, (ViewGroup.LayoutParams)new RelativeLayout.LayoutParams(-1, -1));
    this.t = new FootView(this, this.E);
    super.addView((View)this.t, (ViewGroup.LayoutParams)new RelativeLayout.LayoutParams(-1, -1));
    ...
    this.m.setInterpolator((Interpolator)linearInterpolator);
    this.n.setInterpolator((Interpolator)linearInterpolator);
  }
  ...
  private boolean a(AbsListView paramAbsListView) {
    return (paramAbsListView.getCount() == 0) ? true : ((paramAbsListView.getFirstVisiblePosition() == 0 && paramAbsListView.getChildAt(0).getTop() >= 0));
  }
  
  private boolean a(ExpandableListView paramExpandableListView) {
    return (paramExpandableListView.getCount() == 0) ? true : ((paramExpandableListView.getLastVisiblePosition() == paramExpandableListView.getCount() - 1 && paramExpandableListView.getChildAt(paramExpandableListView.getLastVisiblePosition() - paramExpandableListView.getFirstVisiblePosition()) != null && paramExpandableListView.getChildAt(paramExpandableListView.getLastVisiblePosition() - paramExpandableListView.getFirstVisiblePosition()).getBottom() <= paramExpandableListView.getMeasuredHeight()));
  }
  ...
  private boolean a(ListView paramListView) {
    return (paramListView.getCount() == 0) ? true : ((paramListView.getLastVisiblePosition() == paramListView.getCount() - 1 && paramListView.getChildAt(paramListView.getLastVisiblePosition() - paramListView.getFirstVisiblePosition()) != null && paramListView.getChildAt(paramListView.getLastVisiblePosition() - paramListView.getFirstVisiblePosition()).getBottom() <= paramListView.getMeasuredHeight()));
  }
  ...
  private boolean c() {
    return (!this.F || this.A == null) ? false : ((this.J != null) ? this.J.onPullUp(this.A) : ((this.A instanceof ListView) ? a((ListView)this.A) : ((this.A instanceof GridView) ? a((GridView)this.A) : ((this.A instanceof ExpandableListView) ? a((ExpandableListView)this.A) : ((this.A instanceof ScrollView) ? a((ScrollView)this.A) : ((this.A instanceof WebView) ? a((WebView)this.A) : true))))));
  }
  
  private boolean d() {
    return (!this.G || this.A == null) ? false : ((this.K != null) ? this.K.onPullDown(this.A) : ((this.A instanceof AbsListView) ? a((AbsListView)this.A) : ((this.A instanceof ScrollView) ? a(this.A) : ((this.A instanceof WebView) ? a(this.A) : true))));
  }
  
  private void e() {
    this.p = (View)this.o.getPullView();
    this.s = this.o.getStateText();
    this.q = (View)this.o.getLoadingView();
    this.r = this.o.getStateView();
    this.u = (View)this.t.getPullView();
    this.x = this.t.getStateText();
    this.v = (View)this.t.getLoadingView();
  ...
  public void addView(View paramView, ViewGroup.LayoutParams paramLayoutParams) {
    paramView.setLayoutParams((ViewGroup.LayoutParams)new FrameLayout.LayoutParams(paramLayoutParams.width, paramLayoutParams.height));
    this.A = paramView;
    this.z.addView(paramView);
  }
  ...
  public void autoRefresh() {
    (new AutoRefreshAndLoadTask()).execute((Object[])new Integer[] { Integer.valueOf(20) });
  }
  ...
  public void loadmoreFinish(int paramInt) {
    ...
    if (paramInt != 0) {
      if (paramInt != 2) {
        ...
        imageView = this.w;
        FailDrawable failDrawable = new FailDrawable(this);
      } else {
        this.w.setVisibility(0);
  ...
  private class AutoRefreshAndLoadTask extends AsyncTask<Integer, Float, String> {
    ...
    protected String a(Integer... param1VarArgs) {
      while (this.a.pullDownY < PullingLayout.d(this.a) * 1.0F) {
        PullingLayout pullingLayout = this.a;
        pullingLayout.pullDownY += this.a.MOVE_SPEED;
        publishProgress((Object[])new Float[] { Float.valueOf(this.a.pullDownY) });
        try {
  ...
  public class FootView extends RelativeLayout {
    ...
    private void a(Context param1Context) {
      ...
      addView((View)relativeLayout2, (ViewGroup.LayoutParams)layoutParams2);
      RelativeLayout relativeLayout1 = new RelativeLayout(param1Context);
      RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(-1, -2);
      layoutParams4.addRule(13);
      relativeLayout2.addView((View)relativeLayout1, (ViewGroup.LayoutParams)layoutParams4);
      ...
      relativeLayout1.addView((View)this.e, (ViewGroup.LayoutParams)layoutParams3);
      ...
      layoutParams3.setMargins(PullingLayout.b(this.a, 60.0F), 0, 0, 0);
      layoutParams3.addRule(15);
      relativeLayout1.addView((View)this.b, (ViewGroup.LayoutParams)layoutParams3);
      this.c = new TextView(param1Context);
      this.c.setText(PullingLayout.l(this.a));
      this.c.setTextSize(16.0F);
      layoutParams3 = new RelativeLayout.LayoutParams(-2, -2);
      layoutParams3.addRule(13);
      relativeLayout1.addView((View)this.c, (ViewGroup.LayoutParams)layoutParams3);
      ...
      relativeLayout1.addView((View)this.d, (ViewGroup.LayoutParams)layoutParams1);
    }
  ...
  private class LoadingDrawable extends Drawable {
    ...
    public void setAlpha(int param1Int) {
      this.a.setAlpha(param1Int);
    }
    
    public void setColorFilter(ColorFilter param1ColorFilter) {
      this.a.setColorFilter(param1ColorFilter);
    }
  }
  ...
  class MyTimer {
    ...
    class MyTask extends TimerTask {
      ...
      public MyTask(PullingLayout.MyTimer this$0, Handler param2Handler) {
        this.b = param2Handler;
      }
  ...
  class MyTask extends TimerTask {
    ...
    public MyTask(PullingLayout this$0, Handler param1Handler) {
      this.b = param1Handler;
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\PullingLayout.class
