...
public class SlidingLayout extends HorizontalScrollView {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent) {
    return (this.f || paramMotionEvent.getX() < this.b) ? super.onInterceptTouchEvent(paramMotionEvent) : false;
  }
    ...
    switch (paramMotionEvent.getAction()) {
      ...
      case 2:
        if (!this.k && this.j != null)
          this.j.onMenuStateChange((View)this, this.f); 
        this.k = true;
      case 1:
        break;
    } 
    int i = getScrollX();
    if (this.f ? (i > this.d / 2) : (i > this.d * 1.5D)) {
      closeMenu();
    } else {
      openMenu();
    } 
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\widget\SlidingLayout.class
