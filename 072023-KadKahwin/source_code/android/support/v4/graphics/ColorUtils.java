...
public final class ColorUtils {
  ...
  public static int HSLToColor(@NonNull float[] paramArrayOffloat) {
    ...
    int k = Math.round((f2 + f3) * 255.0F);
    int j = Math.round(255.0F * f3);
    int i = Math.round((f4 + f3) * 255.0F);
    return Color.rgb(constrain(k, 0, 255), constrain(j, 0, 255), constrain(i, 0, 255));
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\support\v4\graphics\ColorUtils.class
