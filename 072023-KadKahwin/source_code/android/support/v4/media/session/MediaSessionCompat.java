...
public class MediaSessionCompat {
  ...
  class MediaSessionStub extends IMediaSession.Stub {
    ...
    public ParcelableVolumeInfo getVolumeAttributes() {
      int i = 2;
      synchronized (this.this$0.mLock) {
        int m = this.this$0.mVolumeType;
        int n = this.this$0.mLocalStream;
        ...
        int j = this.this$0.mAudioManager.getStreamMaxVolume(n);
        int k = this.this$0.mAudioManager.getStreamVolume(n);
        return new ParcelableVolumeInfo(m, n, i, j, k);
      } 
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\support\v4\media\session\MediaSessionCompat.class
