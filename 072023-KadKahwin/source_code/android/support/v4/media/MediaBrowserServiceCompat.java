...
public abstract class MediaBrowserServiceCompat extends Service {
  ...
  void addSubscription(String paramString, ConnectionRecord paramConnectionRecord, IBinder paramIBinder, Bundle paramBundle) {
    List<Pair> list = (List)paramConnectionRecord.subscriptions.get(paramString);
    if (list == null)
      list = new ArrayList(); 
    for (Pair pair : list) {
    ...
    paramConnectionRecord.subscriptions.put(paramString, list);
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\support\v4\media\MediaBrowserServiceCompat.class
