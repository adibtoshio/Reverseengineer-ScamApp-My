...
public class ActivityOptionsCompat {
  ...
  public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity paramActivity, Pair<View, String>... paramVarArgs) {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      ...
      return (ActivityOptionsCompat)((Build.VERSION.SDK_INT >= 24) ? new ActivityOptionsImpl24(ActivityOptionsCompat24.makeSceneTransitionAnimation(paramActivity, arrayOfView, (String[])arrayOfView1)) : ((Build.VERSION.SDK_INT >= 23) ? new ActivityOptionsImpl23(ActivityOptionsCompat23.makeSceneTransitionAnimation(paramActivity, arrayOfView, (String[])arrayOfView1)) : new ActivityOptionsImpl21(ActivityOptionsCompat21.makeSceneTransitionAnimation(paramActivity, arrayOfView, (String[])arrayOfView1))));
    } 
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\support\v4\app\ActivityOptionsCompat.class
