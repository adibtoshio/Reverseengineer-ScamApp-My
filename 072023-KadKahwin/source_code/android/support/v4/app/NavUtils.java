...
public final class NavUtils {
  ...
  static class NavUtilsImplBase implements NavUtilsImpl {
    public Intent getParentActivityIntent(Activity param1Activity) {
      ...
      try {
        return (NavUtils.getParentActivityName((Context)param1Activity, componentName) == null) ? IntentCompat.makeMainActivity(componentName) : (new Intent()).setComponent(componentName);
      } catch (android.content.pm.PackageManager.NameNotFoundException nameNotFoundException) {
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\support\v4\app\NavUtils.class
