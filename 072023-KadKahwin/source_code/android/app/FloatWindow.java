...
public class FloatWindow {
  ...
  private void a(Context paramContext) {
    ...
    this.e.setBackgroundDrawable((Drawable)gradientDrawable);
    this.c.addView((View)this.e, (ViewGroup.LayoutParams)this.d);
  ...
  private void a(boolean paramBoolean) {
    ...
    this.c.updateViewLayout((View)this.e, (ViewGroup.LayoutParams)this.d);
  }
  ...
  private class ContentView extends LinearLayout {
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      if (param1MotionEvent.getAction() == 2) {
        ...
        FloatWindow.d(this.a).updateViewLayout((View)FloatWindow.c(this.a), (ViewGroup.LayoutParams)FloatWindow.b(this.a));
        return true;
      } 
  ...
  private class TitleBar extends LinearLayout {
    ...
    public TitleBar(FloatWindow this$0, Context param1Context) {
      ...
      addView((View)this.b, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(-1, FloatWindow.a(this$0, 24.0F), 1.0F));
      addView((View)textView, (ViewGroup.LayoutParams)new LinearLayout.LayoutParams(FloatWindow.a(this$0, 24.0F), FloatWindow.a(this$0, 24.0F)));
    }
    
    public void setTitle(CharSequence param1CharSequence) {
      this.b.setText(param1CharSequence);
    }
  }
  ...
  private class TitleView extends TextView {
    ...
    public TitleView(FloatWindow this$0, Context param1Context) {
      super(param1Context);
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\android\app\FloatWindow.class
