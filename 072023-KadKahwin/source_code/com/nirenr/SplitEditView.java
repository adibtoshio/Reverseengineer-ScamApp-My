...
public class SplitEditView extends LinearLayout implements View.OnClickListener, AdapterView.OnItemClickListener {
  ...
  private void a(Context paramContext) {
    ...
    this.b.addView((View)this.c, (ViewGroup.LayoutParams)layoutParams3);
    this.b.addView((View)this.d, (ViewGroup.LayoutParams)layoutParams3);
    ...
    for (int i = 0; i < arrayOfString.length; i++) {
      ...
      this.i.addView((View)button, (ViewGroup.LayoutParams)layoutParams1);
    } 
    this.b.addView((View)this.i, (ViewGroup.LayoutParams)layoutParams2);
  ...
  private String[] a(String paramString1, String paramString2) {
    ...
    int i;
    for (i = 0; matcher.find(); i = j) {
      int j = matcher.end();
      if (this.e == 1)
        j = matcher.start(); 
      arrayList.add(paramString1.substring(i, j));
      if (this.e == 1) {
        i = matcher.end();
        continue;
      } 
    ...
    if (i != paramString1.length())
      arrayList.add(paramString1.substring(i)); 
  ...
  private void b() {
    ...
    this.c.setAdapter((ListAdapter)new ArrayListAdapter(this.a, 17367043, (Object[])this.g));
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong) {
    (new EditDialog(this, paramInt)).show();
  }
  ...
  private class EditDialog implements DialogInterface.OnClickListener {
    ...
    public void show() {
      this.d = (new AlertDialog.Builder(SplitEditView.a(this.a))).setTitle("输入内容").setView((View)this.c).setNegativeButton(17039360, null).setPositiveButton(17039370, this).setCancelable(false).create();
