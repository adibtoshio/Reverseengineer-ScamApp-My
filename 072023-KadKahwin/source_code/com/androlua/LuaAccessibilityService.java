...
public class LuaAccessibilityService extends AccessibilityService {
  ...
  private HashMap<String, ComponentName> e = new HashMap<String, ComponentName>();
  ...
  private AccessibilityNodeInfo a(AccessibilityNodeInfo paramAccessibilityNodeInfo) {
    ...
    for (int i = 0; i < j; i++) {
      AccessibilityNodeInfo accessibilityNodeInfo = a(paramAccessibilityNodeInfo.getChild(i));
  ...
  private void a(AccessibilityNodeInfo paramAccessibilityNodeInfo, ArrayList<String> paramArrayList) {
    ...
    if (i > 0)
      for (int j = 0; j < i; j++)
        a(paramAccessibilityNodeInfo.getChild(j), paramArrayList);  
  }
  ...
  private void a(AccessibilityNodeInfo paramAccessibilityNodeInfo1, ArrayList<String> paramArrayList, AccessibilityNodeInfo paramAccessibilityNodeInfo2) {
    ...
    int i = paramAccessibilityNodeInfo1.getChildCount();
    if (i > 0) {
      int j;
      for (j = 0; j < i; j++) {
        AccessibilityNodeInfo accessibilityNodeInfo = paramAccessibilityNodeInfo1.getChild(j);
        if (accessibilityNodeInfo != null) {
          if (!this.f)
  ...
  private void b() {
    (new AsyncTask<String, String, HashMap<String, ComponentName>>(this) {
        protected HashMap<String, ComponentName> a(String... param1VarArgs) {
          ...
          Collections.sort(list2, (Comparator<?>)new ResolveInfo.DisplayNameComparator(packageManager));
          int j = list2.size();
          int i;
          for (i = 0; i < j; i++) {
          ...
          Collections.sort(list1, (Comparator<?>)new ResolveInfo.DisplayNameComparator(packageManager));
          j = list1.size();
          for (i = bool; i < j; i++) {
            ResolveInfo resolveInfo = (ResolveInfo)list1.get(i);
            CharSequence charSequence = resolveInfo.loadLabel(packageManager);
            ComponentName componentName = new ComponentName(resolveInfo.activityInfo.applicationInfo.packageName, resolveInfo.activityInfo.name);
            hashMap.put(charSequence.toString().toLowerCase(), componentName);
          } 
  ...
  private void c() {
    ...
    Collections.sort(list, (Comparator<?>)new ResolveInfo.DisplayNameComparator(packageManager));
    if (list != null) {
      int j = list.size();
      while (i < j) {
  ...
  public boolean click(int paramInt1, int paramInt2) {
    return (this.h != null) ? this.h.click(paramInt1, paramInt2) : false;
  }
  ...
  public boolean click(LuaTable paramLuaTable, LuaFunction paramLuaFunction) {
    return (new ClickRunnable(this, paramLuaTable)).canClick(new ClickRunnable.ClickCallback(this, paramLuaFunction) {
          public void onDone(boolean param1Boolean, LuaTable param1LuaTable, String param1String, int param1Int) {
            try {
              ...
              LuaAccessibilityService.a(this.b, "click", luaException);
              return;
            } 
          }
        });
  ...
  public boolean click(String paramString1, String paramString2, int[] paramArrayOfint) {
    if (paramString1 != null) {
      ...
      for (i = 0; i < j; i++) {
        ...
        if (accessibilityNodeInfo.getChildCount() <= k)
          return false; 
        accessibilityNodeInfo = accessibilityNodeInfo.getChild(k);
        if (accessibilityNodeInfo == null)
          return false; 
      } 
  ...
  public boolean execute(String paramString, AccessibilityNodeInfo paramAccessibilityNodeInfo) {
    ...
    switch (b) {
      ...
      case 7:
        ...
        return true;
      case 6:
        return (Build.VERSION.SDK_INT >= 21) ? paramAccessibilityNodeInfo.performAction(2097152) : false;
      case 5:
        toRecents();
        return true;
      case 4:
  ...
  public AccessibilityNodeInfo findAccessibilityNodeInfo(String paramString) {
    ...
    if (i > 0) {
      if (!paramString.substring(i + 1).equals(getAppName(getFocusView())))
        return null; 
    ...
    if (k > 0) {
      try {
        j = Integer.valueOf(str.substring(k + 1)).intValue();
        i = j;
      } catch (Exception exception) {}
    ...
    if (i != 62) {
      if (i != 64) {
        switch (i) {
          default:
            return findAccessibilityNodeInfoByText(paramString, j);
          case 37:
      ...
      return findAccessibilityNodeInfoById(paramString.substring(1), j);
    } 
  ...
  public AccessibilityNodeInfo findAccessibilityNodeInfoById(String paramString, int paramInt) {
    List<AccessibilityNodeInfo> list = findAccessibilityNodeInfoById(paramString);
    if (list.isEmpty())
      return null; 
    int i = list.size();
    if (paramInt + 1 <= i) {
      if (0 - paramInt > i)
        return null; 
      if (paramInt < 0) {
        list = (List<AccessibilityNodeInfo>)list.get(list.size() + paramInt);
        return (AccessibilityNodeInfo)list;
      } 
      list = (List<AccessibilityNodeInfo>)list.get(paramInt);
      return (AccessibilityNodeInfo)list;
    } 
    return null;
  }
  ...
  public List<AccessibilityNodeInfo> findAccessibilityNodeInfoById(String paramString) {
    AccessibilityNodeInfo accessibilityNodeInfo = getRootInActiveWindow();
    return (accessibilityNodeInfo == null) ? new ArrayList<AccessibilityNodeInfo>() : accessibilityNodeInfo.findAccessibilityNodeInfosByText(paramString);
  }
  ...
  public AccessibilityNodeInfo findAccessibilityNodeInfoByIndex(String paramString) {
    ...
    while (i < j) {
      ...
      try {
        ...
        if (accessibilityNodeInfo1.getChildCount() <= k)
          return null; 
        accessibilityNodeInfo1 = accessibilityNodeInfo1.getChild(k);
    ...
    return (AccessibilityNodeInfo)exception;
  }
  
  public AccessibilityNodeInfo findAccessibilityNodeInfoByText(String paramString, int paramInt) {
    List<AccessibilityNodeInfo> list = findAccessibilityNodeInfoByText(paramString);
    if (list.isEmpty())
      return null; 
    int i = list.size();
    if (paramInt + 1 <= i) {
  ...
  public boolean findClick(String[] paramArrayOfString) {
    ...
    for (int i = 0; i < j; i++) {
      AccessibilityNodeInfo accessibilityNodeInfo = findAccessibilityNodeInfoByText(paramArrayOfString[i], 0);
  ...
  public String getAllText(int paramInt) {
    ArrayList<String> arrayList = getAllTextList();
    StringBuilder stringBuilder = new StringBuilder();
  ...
  public String getAppName(AccessibilityNodeInfo paramAccessibilityNodeInfo) {
    ...
    PackageManager packageManager = getPackageManager();
    try {
      return packageManager.getApplicationLabel(packageManager.getApplicationInfo((String)charSequence, 0)).toString();
  ...
  public AccessibilityNodeInfo getEditText() {
    ArrayList<AccessibilityNodeInfo> arrayList = getAllEditTextList();
  ...
  public void getEditText(AccessibilityNodeInfo paramAccessibilityNodeInfo, ArrayList<AccessibilityNodeInfo> paramArrayList) {
    ...
    if (i > 0)
      for (int j = 0; j < i; j++)
        getEditText(paramAccessibilityNodeInfo.getChild(j), paramArrayList);  
  }
  ...
  public String getNodeInfoText(AccessibilityNodeInfo paramAccessibilityNodeInfo) {
    ...
    return (String)((charSequence1 != null && charSequence1.trim().length() > 0 && (!paramAccessibilityNodeInfo.isEditable() || charSequence2 == null)) ? charSequence1 : ((charSequence2 != null && charSequence2.length() > 0) ? charSequence2.toString() : null));
  }
  
  public Bitmap getScreenshot() {
    return (this.i != null) ? this.i.getScreenShot() : null;
  }
  
  public void getScreenshot(LuaFunction paramLuaFunction) {
    ScreenShot.getScreenCaptureBitmap(this, new ScreenCaptureListener(this, paramLuaFunction) {
  ...
  public boolean longClick(int paramInt1, int paramInt2) {
    return (this.h != null) ? this.h.longClick(paramInt1, paramInt2) : false;
  }
  ...
  public void onAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent) {
    ...
    if (onAccessibilityEvent != null)
      try {
        ...
        stringBuilder.append(luaException.toString());
    ...
    if (luaTable == null)
      return; 
    try {
      ((LuaFunction)luaTable.get("onAccessibilityEvent")).call(new Object[] { luaException });
      return;
    } catch (LuaException luaException1) {
      LuaFunction luaFunction = (LuaFunction)luaTable.get("onError");
      if (luaFunction == null) {
        Log.i("onAccessibilityEvent", luaException1.getMessage());
        return;
      } 
      try {
        luaFunction.call(new Object[] { luaException1 });
        return;
      } catch (LuaException luaException2) {
        Log.i("onAccessibilityEvent", luaException1.getMessage());
        return;
      } 
    } 
  ...
  protected boolean onKeyEvent(KeyEvent paramKeyEvent) {
    return (a != null && a.onKeyEvent(this, paramKeyEvent)) ? true : super.onKeyEvent(paramKeyEvent);
  }
  ...
  public void postClick(long paramLong, LuaTable paramLuaTable) {
    this.g.postDelayed(new Runnable(this, paramLuaTable) {
          public void run() {
            this.b.click(this.a);
          }
        }paramLong);
  ...
  public void postClick(long paramLong, LuaTable paramLuaTable, LuaFunction paramLuaFunction) {
    this.g.postDelayed(new Runnable(this, paramLuaTable, paramLuaFunction) {
          public void run() {
            this.c.click(this.a, this.b);
          }
        }paramLong);
  }
  
  public void postExecute(long paramLong, String paramString, AccessibilityNodeInfo paramAccessibilityNodeInfo) {
    this.g.postDelayed(new Runnable(this, paramString, paramAccessibilityNodeInfo) {
          public void run() {
  ...
  public void postExecute(long paramLong, String paramString, AccessibilityNodeInfo paramAccessibilityNodeInfo, LuaFunction paramLuaFunction) {
    this.g.postDelayed(new Runnable(this, paramLuaFunction, paramString, paramAccessibilityNodeInfo) {
          public void run() {
            try {
  ...
  public boolean press(int paramInt1, int paramInt2, int paramInt3) {
    return (this.h != null) ? this.h.press(paramInt1, paramInt2, paramInt3) : false;
  }
  ...
  public void startScreenshot() {
    this.i = new ScreenShot((Context)this, null);
  }
  
  public void startScreenshot(VirtualDisplay.Callback paramCallback) {
    this.i = new ScreenShot((Context)this, paramCallback);
  }
  ...
  public boolean swipe(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5) {
    return (this.h != null) ? this.h.swipe(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5) : false;
  }
  
  public boolean swipe(Path paramPath, int paramInt) {
    return (this.h != null) ? this.h.gesture(0L, paramInt, paramPath) : false;
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaAccessibilityService.class
