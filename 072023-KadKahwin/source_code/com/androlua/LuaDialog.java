...
public class LuaDialog extends AlertDialog implements DialogInterface.OnClickListener {
  ...
  public void setItems(String[] paramArrayOfString) {
    ...
    setAdapter((ListAdapter)new ArrayListAdapter(this.a, 17367043, arrayList));
  ...
  public void setMultiChoiceItems(CharSequence[] paramArrayOfCharSequence, int[] paramArrayOfint) {
    ArrayList arrayList = new ArrayList(Arrays.asList((Object[])paramArrayOfCharSequence));
    setAdapter((ListAdapter)new ArrayListAdapter(this.a, 17367056, arrayList));
  ...
  public void setSingleChoiceItems(CharSequence[] paramArrayOfCharSequence, int paramInt) {
    ArrayList arrayList = new ArrayList(Arrays.asList((Object[])paramArrayOfCharSequence));
    setAdapter((ListAdapter)new ArrayListAdapter(this.a, 17367055, arrayList));
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaDialog.class
