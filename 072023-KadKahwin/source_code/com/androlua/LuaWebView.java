...
public class LuaWebView extends WebView implements LuaGcable {
  ...
  private HashMap<Long, String[]> b = (HashMap)new HashMap<Long, String>();
  ...
  public LuaWebView(LuaActivity paramLuaActivity) {
    super((Context)paramLuaActivity);
    ...
    setWebViewClient(new WebViewClient(this) {
          public void onReceivedSslError(WebView param1WebView, SslErrorHandler param1SslErrorHandler, SslError param1SslError) {
            AlertDialog.Builder builder = new AlertDialog.Builder((Context)LuaWebView.b(this.a));
          ...
          public boolean shouldOverrideUrlLoading(WebView param1WebView, String param1String) {
            ...
            try {
              ...
              LuaWebView.b(this.a).sendError("LuaWebView", exception);
              return true;
            } 
          }
        });
    this.f = paramLuaActivity.getResources().getDisplayMetrics();
    int i = (int)TypedValue.applyDimension(1, 2.0F, this.f);
    this.e = new ProgressBar((Context)paramLuaActivity, null, 16842872);
    this.e.setLayoutParams((ViewGroup.LayoutParams)new AbsoluteLayout.LayoutParams(-1, i, 0, 0));
    addView((View)this.e);
  ...
  public void addJSInterface(JsInterface paramJsInterface, String paramString) {
    addJavascriptInterface(new JsObject(this, paramJsInterface), paramString);
  }
    ...
    if (this.g == null) {
      ...
      this.h.setOnItemClickListener(new AdapterView.OnItemClickListener(this) {
            public void onItemClick(AdapterView<?> param1AdapterView, View param1View, int param1Int, long param1Long) {
              ...
              stringBuilder.append((String)luaWebView);
              String str1 = stringBuilder.toString();
              if ((new File(str1)).isDirectory()) {
                LuaWebView.a(this.a, str1);
                this.a.openFile(LuaWebView.c(this.a));
                return;
              } 
              LuaWebView.d(this.a).onReceiveValue(Uri.parse(str1));
            }
          });
    } 
  ...
  public void setOnDownloadStartListener(OnDownloadStartListener paramOnDownloadStartListener) {
    setDownloadListener(new DownloadListener(this, paramOnDownloadStartListener) {
          public void onDownloadStart(String param1String1, String param1String2, String param1String3, String param1String4, long param1Long) {
            this.a.onDownloadStart(param1String1, param1String2, param1String3, param1String4, param1Long);
          }
        });
  }
  ...
  public void setWebViewClient(LuaWebViewClient paramLuaWebViewClient) {
    setWebViewClient(new SimpleLuaWebViewClient(this, paramLuaWebViewClient));
  }
  ...
  private class Download implements DownloadListener {
    ...
    private long a(boolean param1Boolean) {
      if (LuaWebView.g(this.b) == null) {
        ...
        LuaWebView.a(this.b, new LuaWebView.DownloadBroadcastReceiver());
  ...
  class JsObject {
    ...
    public JsObject(LuaWebView this$0, LuaWebView.JsInterface param1JsInterface) {
      this.b = param1JsInterface;
    }
    
    @JavascriptInterface
    public String execute(String param1String) {
      return this.b.execute(param1String);
    }
  }
  ...
  private class LuaJavaScriptInterface {
    ...
    public LuaJavaScriptInterface(LuaWebView this$0, LuaActivity param1LuaActivity) {
      this.b = param1LuaActivity;
    }
    
    @JavascriptInterface
    public Object callLuaFunction(String param1String) {
      return this.b.runFunc(param1String, new Object[0]);
    }
    
    @JavascriptInterface
    public Object callLuaFunction(String param1String1, String param1String2) {
      return this.b.runFunc(param1String1, new Object[] { param1String2 });
    }
    
    @JavascriptInterface
    public Object doLuaString(String param1String) {
      return this.b.doString(param1String, new Object[0]);
    }
  }
  
  class LuaWebChromeClient extends WebChromeClient {
    EditText a = new EditText((Context)LuaWebView.b(this.b));
    
    LuaWebChromeClient(LuaWebView this$0) {}
    
    public Bitmap getDefaultVideoPoster() {
      return BitmapFactory.decodeResource(LuaWebView.b(this.b).getResources(), 2130771968);
    }
    
    public boolean onJsAlert(WebView param1WebView, String param1String1, String param1String2, JsResult param1JsResult) {
      (new AlertDialog.Builder((Context)LuaWebView.b(this.b))).setTitle(param1String1).setMessage(param1String2).setPositiveButton(17039370, new DialogInterface.OnClickListener(this, param1JsResult) {
            public void onClick(DialogInterface param2DialogInterface, int param2Int) {
              this.a.confirm();
            }
    ...
    public boolean onJsConfirm(WebView param1WebView, String param1String1, String param1String2, JsResult param1JsResult) {
      AlertDialog.Builder builder = new AlertDialog.Builder((Context)LuaWebView.b(this.b));
    ...
    public void openFileChooser(ValueCallback<Uri> param1ValueCallback) {
      openFileChooser(param1ValueCallback, "");
    }
    ...
    public void openFileChooser(ValueCallback<Uri> param1ValueCallback, String param1String1, String param1String2) {
      openFileChooser(param1ValueCallback, param1String1);
    }
  }
  ...
  private class SimpleLuaWebViewClient extends WebViewClient {
    ...
    public SimpleLuaWebViewClient(LuaWebView this$0, LuaWebView.LuaWebViewClient param1LuaWebViewClient) {
      this.b = param1LuaWebViewClient;
    }
    
    public void doUpdateVisitedHistory(WebView param1WebView, String param1String, boolean param1Boolean) {
      this.b.doUpdateVisitedHistory(param1WebView, param1String, param1Boolean);
    }
    
    public void onFormResubmission(WebView param1WebView, Message param1Message1, Message param1Message2) {
      param1Message1.sendToTarget();
    }
    
    public void onLoadResource(WebView param1WebView, String param1String) {
      this.b.onLoadResource(param1WebView, param1String);
    }
    
    public void onPageFinished(WebView param1WebView, String param1String) {
      this.b.onPageFinished(param1WebView, param1String);
    }
    
    public void onPageStarted(WebView param1WebView, String param1String, Bitmap param1Bitmap) {
      this.b.onPageStarted(param1WebView, param1String, param1Bitmap);
    }
    
    public void onProceededAfterSslError(WebView param1WebView, SslError param1SslError) {
      this.b.onProceededAfterSslError(param1WebView, param1SslError);
    }
    
    public void onReceivedClientCertRequest(WebView param1WebView, ClientCertRequest param1ClientCertRequest, String param1String) {
      this.b.onReceivedClientCertRequest(param1WebView, param1ClientCertRequest, param1String);
    }
    
    public void onReceivedError(WebView param1WebView, int param1Int, String param1String1, String param1String2) {
      this.b.onReceivedError(param1WebView, param1Int, param1String1, param1String2);
    }
    ...
    public void onReceivedHttpAuthRequest(WebView param1WebView, HttpAuthHandler param1HttpAuthHandler, String param1String1, String param1String2) {
      this.b.onReceivedHttpAuthRequest(param1WebView, param1HttpAuthHandler, param1String1, param1String2);
    }
    
    public void onReceivedLoginRequest(WebView param1WebView, String param1String1, String param1String2, String param1String3) {
      this.b.onReceivedLoginRequest(param1WebView, param1String1, param1String2, param1String3);
    }
    
    public void onReceivedSslError(WebView param1WebView, SslErrorHandler param1SslErrorHandler, SslError param1SslError) {
      this.b.onReceivedSslError(param1WebView, param1SslErrorHandler, param1SslError);
    }
    
    public void onScaleChanged(WebView param1WebView, float param1Float1, float param1Float2) {
      this.b.onScaleChanged(param1WebView, param1Float1, param1Float2);
    }
    ...
    public void onUnhandledKeyEvent(WebView param1WebView, KeyEvent param1KeyEvent) {
      this.b.onUnhandledKeyEvent(param1WebView, param1KeyEvent);
    }
    ...
    public boolean shouldOverrideKeyEvent(WebView param1WebView, KeyEvent param1KeyEvent) {
      return this.b.shouldOverrideKeyEvent(param1WebView, param1KeyEvent);
    }
    
    public boolean shouldOverrideUrlLoading(WebView param1WebView, String param1String) {
      return this.b.shouldOverrideUrlLoading(param1WebView, param1String);
    }
  }
}


/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaWebView.class
