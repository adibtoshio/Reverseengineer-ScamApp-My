...
public class Download {
  ...
  private HashMap<Long, String[]> e = (HashMap)new HashMap<Long, String>();
  ...
  public long start(boolean paramBoolean) {
    ...
    this.e.put(Long.valueOf(l), new String[] { (new File(this.h, this.l)).getAbsolutePath(), this.j });
    return l;
  }
  ...
  public void start(String paramString1, String paramString2, String paramString3, String paramString4) {
    ...
    if (this.g == null)
      this.g = paramString1; 
    (new AlertDialog.Builder(this.a.getContext())).setTitle("Download").setMessage(this.g).setView((View)this.b).setPositiveButton("Download", new DialogInterface.OnClickListener(this) {
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\Download.class
