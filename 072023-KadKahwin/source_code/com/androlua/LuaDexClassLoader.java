...
public class LuaDexClassLoader extends DexClassLoader {
  private HashMap<String, Class<?>> a = new HashMap<String, Class<?>>();
  ...
  protected Class<?> findClass(String paramString) {
    Class<?> clazz2 = this.a.get(paramString);
    Class<?> clazz1 = clazz2;
    if (clazz2 == null) {
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaDexClassLoader.class
