...
public class LuaRunnable extends Thread implements LuaGcable, LuaMetaTable, Runnable {
  ...
  public LuaRunnable(LuaContext paramLuaContext, LuaObject paramLuaObject) {
    this(paramLuaContext, paramLuaObject, false, (Object[])null);
  }
  
  public LuaRunnable(LuaContext paramLuaContext, LuaObject paramLuaObject, boolean paramBoolean) {
    this(paramLuaContext, paramLuaObject, paramBoolean, (Object[])null);
  }
  ...
  public LuaRunnable(LuaContext paramLuaContext, String paramString) {
    this(paramLuaContext, paramString, false, (Object[])null);
  }
  
  public LuaRunnable(LuaContext paramLuaContext, String paramString, boolean paramBoolean) {
    this(paramLuaContext, paramString, paramBoolean, (Object[])null);
  }
  ...
  private void a() {
    ...
    //   197: new com/androlua/LuaRunnable$2
    //   200: dup
    //   201: aload_0
    //   202: aload_0
    //   203: getfield b : Lcom/luajava/LuaState;
    //   206: invokespecial <init> : (Lcom/androlua/LuaRunnable;Lcom/luajava/LuaState;)V
    //   209: ldc 'set'
    //   211: invokevirtual register : (Ljava/lang/String;)V
    //   214: new com/androlua/LuaRunnable$3
    //   217: dup
    //   218: aload_0
    //   219: aload_0
    //   220: getfield b : Lcom/luajava/LuaState;
    //   223: invokespecial <init> : (Lcom/androlua/LuaRunnable;Lcom/luajava/LuaState;)V
    //   226: ldc 'call'
  ...
  private void a(String paramString, Object paramObject) {
    try {
      ...
      this.d.sendMsg(luaException.getMessage());
      return;
    } 
  }
  ...
  private void a(String paramString, Object... paramVarArgs) {
    try {
      ...
      luaContext.sendMsg(stringBuilder.toString());
      quit();
      return;
    } 
  }
  ...
  private class ThreadHandler extends Handler {
    private ThreadHandler(LuaRunnable this$0) {}
    ...
    public void handleMessage(Message param1Message) {
      ...
      switch (param1Message.what) {
        default:
          return;
        case 4:
          LuaRunnable.a(this.a, bundle.getString("data"), ((Object[])bundle.getSerializable("args"))[0]);
          return;
        case 3:
          LuaRunnable.b(this.a, bundle.getString("data"), new Object[0]);
          return;
        case 2:
          LuaRunnable.a(this.a, bundle.getString("data"), new Object[0]);
          return;
        case 1:
          LuaRunnable.b(this.a, bundle.getString("data"), (Object[])bundle.getSerializable("args"));
          return;
        case 0:
          break;
      } 
      LuaRunnable.a(this.a, bundle.getString("data"), (Object[])bundle.getSerializable("args"));
    }
  }
}


/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaRunnable.class
