...
public class LuaBitmapDrawable extends Drawable implements LuaGcable, Runnable {
  ...
  private void a(LuaContext paramLuaContext, String paramString) {
    (new AsyncTaskX<String, String, String>(this, paramLuaContext, paramString) {
        ...
        protected void a(String param1String) {
          LuaBitmapDrawable.a(this.c, param1String);
        }
  ...
  private void b(String paramString) {
    if (paramString.isEmpty()) {
      (new Handler()).postDelayed(new Runnable(this) {
            public void run() {
              LuaBitmapDrawable.c(this.a).setState(-1);
            }
          },  1000L);
      invalidateSelf();
      return;
    ...
    if (this.e != null) {
      ...
      try {
        ...
        try {
          this.g = (Drawable)new BitmapDrawable(LuaBitmap.getLocalBitmap(this.a, paramString));
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaBitmapDrawable.class
