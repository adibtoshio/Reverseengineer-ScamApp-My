...
public class LuaThread extends Thread implements LuaGcable, LuaMetaTable, Runnable {
  ...
  private void a(String paramString, Object paramObject) {
    try {
      ...
      this.d.sendError(toString(), (Exception)luaException);
      return;
    } 
  }
  ...
  private void a(String paramString, Object... paramVarArgs) {
    try {
      ...
      this.d.sendError(toString(), exception);
      quit();
      return;
    } 
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaThread.class
