...
public class LoadingDrawable extends Drawable {
  ...
  public void draw(Canvas paramCanvas) {
    ...
    int i = (int)Math.min(rect.right, rect.bottom);
    int j = rect.right;
    int k = rect.bottom;
    rect.right = i;
    rect.bottom = i;
    paramCanvas.save();
    paramCanvas.translate(((j - i) / 2), ((k - i) / 2));
    float f2 = i;
    float f1 = 0.15F * f2;
    f2 *= 0.85F;
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LoadingDrawable.class
