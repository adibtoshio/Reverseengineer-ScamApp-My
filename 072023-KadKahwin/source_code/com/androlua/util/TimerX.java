...
public class TimerX {
  ...
  public TimerX(boolean paramBoolean) {
    this(stringBuilder.toString(), paramBoolean);
  }
  ...
  private void a(TimerTaskX paramTimerTaskX, long paramLong1, long paramLong2, boolean paramBoolean) {
    synchronized (this.b) {
      ...
      synchronized (((TimerTaskX)null).b) {
        if (null.a())
          throw new IllegalStateException("TimerTask is scheduled already"); 
        if (((TimerTaskX)null).c)
          throw new IllegalStateException("TimerTask is canceled"); 
        ((TimerTaskX)null).d = paramLong1;
        ((TimerTaskX)null).e = paramLong2;
        ((TimerTaskX)null).f = paramBoolean;
        TimerImpl.a(this.b, (TimerTaskX)null);
        return;
      } 
    } 
  }
  ...
  private static final class FinalizerHelper {
    ...
    FinalizerHelper(TimerX.TimerImpl param1TimerImpl) {
      this.a = param1TimerImpl;
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlu\\util\TimerX.class
