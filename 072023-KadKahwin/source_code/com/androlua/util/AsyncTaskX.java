...
public abstract class AsyncTaskX<Params, Progress, Result> {
  ...
  private static final BlockingQueue<Runnable> c = new LinkedBlockingQueue<Runnable>(1024);
  ...
  protected final void c(Progress... paramVarArgs) {
    if (!isCancelled())
      d().obtainMessage(2, new AsyncTaskResult<Progress>(this, paramVarArgs)).sendToTarget(); 
  }
  ...
  public final AsyncTaskX<Params, Progress, Result> execute(Params... paramVarArgs) {
    return executeOnExecutor(d, paramVarArgs);
  }
  ...
  private static class InternalHandler extends Handler {
    public InternalHandler(Looper param1Looper) {
      super(param1Looper);
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlu\\util\AsyncTaskX.class
