...
public class LuaArrayAdapter extends ArrayListAdapter {
  ...
  public LuaArrayAdapter(LuaContext paramLuaContext, LuaObject paramLuaObject) {
    this(paramLuaContext, paramLuaObject, (Object[])new String[0]);
  }
  ...
  private void a(View paramView, Object paramObject) {
    ...
    if (textView instanceof ImageView)
      try {
        ...
        textView = null;
        if (bool) {
          BitmapDrawable bitmapDrawable = new BitmapDrawable(this.a, (Bitmap)paramObject);
        } else if (paramObject instanceof String) {
          drawable = (new AsyncLoader()).getBitmap(this.b, (String)paramObject);
  ...
  private class AsyncLoader extends Thread {
    ...
    public Drawable getBitmap(LuaContext param1LuaContext, String param1String) {
      ...
      if (!param1String.toLowerCase().startsWith("http://") && !param1String.toLowerCase().startsWith("https://"))
        return (Drawable)new BitmapDrawable(LuaArrayAdapter.a(this.a), LuaBitmap.getBitmap(param1LuaContext, param1String)); 
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaArrayAdapter.class
