...
public class LuaResources extends Resources implements LuaMetaTable {
  ...
  private final HashMap<Integer, String> b = new HashMap<Integer, String>();
  
  private final HashMap<Integer, Drawable> c = new HashMap<Integer, Drawable>();
  
  private final HashMap<Integer, Integer> d = new HashMap<Integer, Integer>();
  
  private final HashMap<Integer, String[]> e = (HashMap)new HashMap<Integer, String>();
  
  private final HashMap<Integer, int[]> f = (HashMap)new HashMap<Integer, int>();
  
  private final HashMap<Integer, Typeface> g = new HashMap<Integer, Typeface>();
  
  private final HashMap<Integer, Integer> h = new HashMap<Integer, Integer>();
  
  private final HashMap<Integer, Float> i = new HashMap<Integer, Float>();
  
  private final HashMap<Integer, Boolean> j = new HashMap<Integer, Boolean>();
  
  private final HashMap<String, Integer> k = new HashMap<String, Integer>();
  ...
  public boolean getBoolean(int paramInt) {
    Boolean bool = this.j.get(Integer.valueOf(paramInt));
    return (bool != null) ? bool.booleanValue() : this.l.getBoolean(paramInt);
  }
  
  public int getColor(int paramInt) {
    Integer integer = this.d.get(Integer.valueOf(paramInt));
  ...
  public Drawable getDrawable(int paramInt) {
    Drawable drawable = this.c.get(Integer.valueOf(paramInt));
  ...
  public Typeface getFont(int paramInt) {
    Typeface typeface = this.g.get(Integer.valueOf(paramInt));
  ...
  public int[] getIntArray(int paramInt) {
    int[] arrayOfInt = this.f.get(Integer.valueOf(paramInt));
  ...
  public String getQuantityString(int paramInt1, int paramInt2, Object... paramVarArgs) {
    return this.l.getQuantityString(paramInt1, paramInt2, paramVarArgs);
  }
  ...
  public String[] getStringArray(int paramInt) {
    String[] arrayOfString = this.e.get(Integer.valueOf(paramInt));
  ...
  public CharSequence[] getTextArray(int paramInt) {
    String[] arrayOfString = this.e.get(Integer.valueOf(paramInt));
    return (CharSequence[])((arrayOfString != null) ? arrayOfString : this.l.getTextArray(paramInt));
  }
  ...
  public int put(String paramString, Object paramObject) {
    ...
    if (paramObject instanceof Drawable) {
      ...
      setTextArray(i, (String[])paramObject);
    } else if (paramObject instanceof Number) {
      setColor(i, ((Number)paramObject).intValue());
    } else {
      if (paramObject instanceof int[]) {
        setIntArray(i, (int[])paramObject);
        this.k.put(paramString, Integer.valueOf(i));
        return i;
      } 
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaResources.class
