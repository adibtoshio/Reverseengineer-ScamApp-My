...
public class LuaService extends Service implements LuaBroadcastReceiver.OnReceiveListener, LuaContext {
  ...
  private ArrayList<LuaGcable> d = new ArrayList<LuaGcable>();
  ...
  public Object doAsset(String paramString, Object... paramVarArgs) {
    try {
      ...
      this.h.setTop(0);
      int k = this.h.LloadBuffer(arrayOfByte, paramString);
      i = k;
      if (k == 0) {
    ...
    int j;
    for (j = 0; j < i; j++)
      this.h.pushObjectValue(paramVarArgs[j]); 
    j = this.h.pcall(i, 0, -2 - i);
    int i = j;
    if (j == 0)
  ...
  public Object doFile(String paramString, Object[] paramArrayOfObject) {
    ...
    try {
      ...
      if (k == 0) {
        ...
        while (j < i) {
          this.h.pushObjectValue(paramArrayOfObject[j]);
          j++;
        } 
        i = this.h.pcall(i, 1, -2 - i);
        j = i;
        if (i == 0)
          return this.h.toJavaObject(-1); 
      } 
  ...
  public Object doString(String paramString, Object... paramVarArgs) {
    try {
      ...
      int j = 0;
      luaState.setTop(0);
      int k = this.h.LloadString(paramString);
      int i = k;
      if (k == 0) {
        this.h.getGlobal("debug");
        this.h.getField(-1, "traceback");
        ...
        while (i < j) {
          this.h.pushObjectValue(paramVarArgs[i]);
          i++;
        } 
        j = this.h.pcall(j, 1, -2 - j);
        i = j;
        if (j == 0)
          return this.h.toJavaObject(-1); 
      } 
  ...
  public AssetManager getAssets() {
    return (this.c != null && this.c.getAssets() != null) ? this.c.getAssets() : super.getAssets();
  }
  ...
  public Resources getResources() {
    return (this.c != null && this.c.getResources() != null) ? this.c.getResources() : ((this.s != null) ? this.s : super.getResources());
  }
  ...
  public IBinder onBind(Intent paramIntent) {
    ...
    return (IBinder)new LuaBinder(this);
  }
  ...
  public Object runFunc(String paramString, Object... paramVarArgs) {
    if (this.h != null)
      try {
        ...
        stringBuilder.append(paramString);
        stringBuilder.append(" ");
        stringBuilder.append(luaException.getMessage());
  ...
  public void showToast(String paramString) {
    try {
      ...
      if (this.p == null || l - this.r > 1000L) {
        this.q.setLength(0);
        this.p = Toast.makeText((Context)this, paramString, 1);
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaService.class
