...
public class NineBitmapDrawable extends Drawable implements LuaGcable {
  ...
  public void draw(Canvas paramCanvas) {
    ...
    Rect rect2 = new Rect(this.c, 0, i - this.e, this.d);
    Rect rect3 = new Rect(i - this.e, 0, i, this.d);
    Rect rect4 = new Rect(0, this.d, this.c, j - this.f);
    Rect rect5 = new Rect(this.c, this.d, i - this.e, j - this.f);
    Rect rect6 = new Rect(i - this.e, this.d, i, j - this.f);
    Rect rect7 = new Rect(0, j - this.f, this.c, j);
    Rect rect8 = new Rect(this.c, j - this.f, i - this.e, j);
    Rect rect9 = new Rect(i - this.e, j - this.f, i, j);
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\NineBitmapDrawable.class
