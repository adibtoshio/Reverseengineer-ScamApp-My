...
public class LuaDrawable extends Drawable {
  ...
  public LuaDrawable(LuaFunction paramLuaFunction) {
    this.b = (LuaObject)paramLuaFunction;
    this.c = new Paint();
  ...
  public void draw(Canvas paramCanvas) {
    try {
      ...
      this.a.sendError("onDraw", (Exception)luaException);
    } 
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\androlua\LuaDrawable.class
