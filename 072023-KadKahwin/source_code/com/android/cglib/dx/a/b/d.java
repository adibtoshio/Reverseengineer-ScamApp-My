...
public final class d extends ag {
  ...
  public void a(l paraml) {
    ...
    if (this.c != null) {
      Iterator<ac> iterator = this.c.iterator();
      while (iterator.hasNext())
        ((ac)iterator.next()).a(paraml); 
    } 
    if (this.d != null) {
      Iterator<ah> iterator = this.d.iterator();
      while (iterator.hasNext())
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\a\b\d.class
