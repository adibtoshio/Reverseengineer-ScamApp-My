...
public final class j {
  ...
  private int a(int paramInt) {
    int i = this.b.a();
    while (paramInt < i && this.b.a(paramInt).a() == this.i) {
  ...
  private int a(int paramInt, ArrayList<u.a> paramArrayList) {
    ...
    while (paramInt < i && ((u.a)paramArrayList.get(paramInt)).a() == this.i) {
      a(paramArrayList.get(paramInt));
      paramInt++;
    } 
    return paramInt;
  }
  ...
  private void b(int paramInt) {
    ...
    if (this.k != null || this.l != null)
      a(this.c.g() - i, String.format("line = %d", new Object[] { Integer.valueOf(this.j) })); 
  }
  ...
  private void b(p.b paramb) {
    ...
    d(paramb.g());
    if (this.k != null || this.l != null)
      a(this.c.g() - i, String.format("%04x: +local restart %s", new Object[] { Integer.valueOf(this.i), a(paramb) })); 
  }
  
  private byte[] b() {
    ArrayList<u.a> arrayList = c();
    a(arrayList, e());
    this.c.b(7);
    a a1 = this.k;
    int k = 0;
    ...
    for (int i = 0;; i = i2) {
      ...
      if (i2 < m) {
        k = ((u.a)arrayList.get(i2)).a();
      } else {
        k = Integer.MAX_VALUE;
      } 
      int i3 = Math.min(k, i);
      if (i3 == Integer.MAX_VALUE || (i3 == this.e && i == Integer.MAX_VALUE && k == Integer.MAX_VALUE)) {
        f();
        return this.c.f();
      } 
      if (i3 == k) {
  ...
  private ArrayList<u.a> c() {
    ...
    ArrayList<u.a> arrayList = new ArrayList(i);
    while (k < i) {
      arrayList.add(this.a.a(k));
      k++;
    } 
    Collections.sort(arrayList, new Comparator<u.a>(this) {
          public int a(u.a param1a1, u.a param1a2) {
            return param1a1.a() - param1a2.a();
          }
  ...
  private void c(int paramInt) {
    ...
    this.i += paramInt;
    if (this.k != null || this.l != null)
      a(this.c.g() - i, String.format("%04x: advance pc", new Object[] { Integer.valueOf(this.i) })); 
  }
  ...
  private void c(p.b paramb) {
    ...
    a(paramb.f());
    if (this.k != null || this.l != null)
      a(this.c.g() - i, String.format("%04x: +local %s", new Object[] { Integer.valueOf(this.i), a(paramb) })); 
  }
  
  private int d() {
    return this.f - this.g.c().b() - (this.h ^ true);
  }
  ...
  private void d(p.b paramb) {
    ...
    a(paramb.e());
    if (this.k != null || this.l != null)
      a(this.c.g() - i, String.format("%04x: +localx %s", new Object[] { Integer.valueOf(this.i), a(paramb) })); 
  }
  
  private ArrayList<p.b> e() {
    ArrayList<p.b> arrayList = new ArrayList(this.g.c().a());
    int k = d();
    BitSet bitSet = new BitSet(this.f - k);
    int m = this.b.a();
    for (int i = 0; i < m; i++) {
      p.b b1 = this.b.a(i);
      int n = b1.g();
    ...
    Collections.sort(arrayList, new Comparator<p.b>(this) {
          public int a(p.b param1b1, p.b param1b2) {
            return param1b1.g() - param1b2.g();
          }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\a\b\j.class
