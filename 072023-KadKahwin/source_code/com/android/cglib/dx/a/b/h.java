...
public final class h extends as {
  private final TreeMap<c, g> a = new TreeMap<c, g>();
  ...
  public Collection<? extends x> a() {
    return (Collection<? extends x>)((this.b != null) ? this.b : this.a.values());
  }
  ...
  protected void b() {
    int j = this.a.size();
    this.b = new ArrayList<g>(j);
    Iterator<c> iterator = this.a.keySet().iterator();
    for (int i = 0; iterator.hasNext(); i = a(iterator.next(), i, j - i));
  }
}


/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\a\b\h.class
