...
public final class am extends ag {
  ...
  private static int a(v paramv) {
    return n.a(paramv.j()) + paramv.i() + 1;
  }
  
  protected int a(ag paramag) {
    paramag = paramag;
    return this.a.a((a)((am)paramag).a);
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\a\b\am.class
