...
public final class TypeId<T> {
  ...
  public static <T> TypeId<T> get(Class<T> paramClass) {
    ...
    if (paramClass.isPrimitive())
      return (TypeId<T>)d.get(paramClass); 
  ...
  public static <T> TypeId<T> get(String paramString) {
    return new TypeId<T>(paramString, c.b(paramString));
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\TypeId.class
