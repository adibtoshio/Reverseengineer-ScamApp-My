...
public final class v extends x {
  ...
  public static byte[] a(String paramString) {
    ...
    while (j < k) {
      ...
      if (c1 != '\000' && c1 < '') {
        arrayOfByte2[i] = (byte)c1;
        i++;
      } else if (c1 < 'ࠀ') {
        arrayOfByte2[i] = (byte)(c1 >> 6 & 0x1F | 0xC0);
        arrayOfByte2[i + 1] = (byte)(c1 & 0x3F | 0x80);
        i += 2;
      } else {
        arrayOfByte2[i] = (byte)(c1 >> 12 & 0xF | 0xE0);
        arrayOfByte2[i + 1] = (byte)(c1 >> 6 & 0x3F | 0x80);
        arrayOfByte2[i + 2] = (byte)(c1 & 0x3F | 0x80);
        i += 3;
      } 
      j++;
    } 
  ...
  public boolean equals(Object paramObject) {
    return !(paramObject instanceof v) ? false : this.b.equals(((v)paramObject).b);
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\c\c\v.class
