...
public abstract class f implements r {
  ...
  protected final String b(String paramString) {
    ...
    if (i == 0) {
      ...
      for (int j = 0; j < i; j++) {
        stringBuffer.append(" ");
        stringBuffer.append(this.d.b(j).a_());
      } 
    } 
    return stringBuffer.toString();
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\android\cglib\dx\c\b\f.class
