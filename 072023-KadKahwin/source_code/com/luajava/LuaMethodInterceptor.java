...
public class LuaMethodInterceptor implements MethodInterceptor {
  ...
  private class SuperCall implements LuaMetaTable {
    ...
    public Object __call(Object... param1VarArgs) {
      return this.c.invokeSuper(this.b, param1VarArgs);
    }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\luajava\LuaMethodInterceptor.class
