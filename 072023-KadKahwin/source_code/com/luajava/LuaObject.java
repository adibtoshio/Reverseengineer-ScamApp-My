...
public class LuaObject implements Serializable {
  ...
  public LuaObject[] _call_aux(Object[] paramArrayOfObject, int paramInt) {
    synchronized (this.b) {
      ...
      int i = this.b.pcall(bool, paramInt, 0);
      if (i != 0) {
        String str2;
        StringBuilder stringBuilder;
        if (this.b.isString(-1)) {
          str2 = this.b.toString(-1);
          this.b.pop(1);
        } else {
          str2 = "";
        } 
        if (i == 2) {
          ...
          stringBuilder1.append("Runtime error. ");
          stringBuilder1.append(str2);
          stringBuilder = stringBuilder1;
        } else if (i == 4) {
          StringBuilder stringBuilder1 = new StringBuilder();
          stringBuilder1.append("Memory allocation error. ");
          stringBuilder1.append((String)stringBuilder);
          stringBuilder = stringBuilder1;
        } else if (i == 6) {
          StringBuilder stringBuilder1 = new StringBuilder();
          stringBuilder1.append("Error while running the error handler function. ");
          stringBuilder1.append((String)stringBuilder);
          stringBuilder = stringBuilder1;
        } else {
          StringBuilder stringBuilder1 = new StringBuilder();
          stringBuilder1.append("Lua Error code ");
          stringBuilder1.append(i);
          stringBuilder1.append(". ");
          stringBuilder1.append((String)stringBuilder);
          str1 = stringBuilder1.toString();
          throw new LuaException(str1);
        } 
  ...
  public Object[] asArray() {
    synchronized (this.b) {
      ...
      Object object = Array.newInstance(Object.class, j);
      int i = 1;
      while (true) {
        if (i <= j) {
          ...
          this.b.getTable(-2);
          try {
            Array.set(object, i - 1, this.b.toJavaObject(-1));
  ...
  public Object createProxy(String paramString) {
    synchronized (this.b) {
      ...
      for (int i = 0; stringTokenizer.hasMoreTokens(); i++)
        arrayOfClass[i] = Class.forName(stringTokenizer.nextToken()); 
      LuaInvocationHandler luaInvocationHandler = new LuaInvocationHandler(this);
  ...
  public LuaTable<?, ?> getTable() {
    synchronized (this.b) {
      push();
      LuaTable<Object, Object> luaTable = new LuaTable<Object, Object>(this.b, -1);
      this.b.pop(1);
      return luaTable;
    } 
  }
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\luajava\LuaObject.class
