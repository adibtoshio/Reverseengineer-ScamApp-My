...
public final class LuaJavaAPI {
  private static final HashMap<Class<?>, HashMap<String, ArrayList<Method>>> a = new HashMap<Class<?>, HashMap<String, ArrayList<Method>>>();
  ...
  public static final HashMap<Class<?>, Method[]> methodsMap = (HashMap)new HashMap<Class<?>, Method>();
  
  static {
    methodCache = (HashMap)new HashMap<String, Method>();
    b = new HashMap<String, Method>();
    c = new HashMap<String, Method>();
    d = new HashMap<String, Method>();
    e = new HashMap<String, Method>();
    f = new HashMap<String, Method>();
  }
  ...
  private static int a(LuaState paramLuaState, Class<?> paramClass) {
    paramClass = (new LuaEnhancer(paramClass)).create(new MethodFilter() {
          public boolean filter(Method param1Method, String param1String) {
            return ((param1Method.getModifiers() & 0x400) == 0);
          }
        });
    try {
  ...
  private static int f(LuaState paramLuaState, Class<char> paramClass, int paramInt) {
    char c;
    if (paramClass == char.class && paramLuaState.type(paramInt) == 4) {
      ...
      if (!paramLuaState.isNumber(paramInt)) {
        ...
        stringBuilder.append(paramLuaState.toString(paramInt));
        stringBuilder.append(" is not number");
        throw new LuaException(stringBuilder.toString());
      } 
      if (stringBuilder == double.class) {
        double_ = Double.valueOf(paramLuaState.toNumber(paramInt));
      } else {
        Float float_;
        if (double_ == float.class) {
          float_ = Float.valueOf((float)paramLuaState.toNumber(paramInt));
        } else {
          Long long_;
          if (float_ == long.class) {
            long_ = Long.valueOf(paramLuaState.toInteger(paramInt));
          } else {
            Integer integer;
            if (long_ == int.class) {
              ...
              if (integer == short.class) {
                short_ = Short.valueOf((short)(int)paramLuaState.toInteger(paramInt));
              } else {
                if (short_ == char.class) {
                  c = (char)(int)paramLuaState.toInteger(paramInt);
                } else {
                  Byte byte_;
                  if (short_ == byte.class) {
                    byte_ = Byte.valueOf((byte)(int)paramLuaState.toInteger(paramInt));
                  } else if (byte_ == boolean.class) {
                    Boolean bool = Boolean.valueOf(paramLuaState.toBoolean(paramInt));
                  } else {
                    byte_ = null;
                  } 
                  paramLuaState.pushJavaObject(byte_);
                  return 1;
                } 
                character1 = Character.valueOf(c);
              } 
            } 
          } 
        } 
  ...
  public static ArrayList<Method> getMethod(Class<?> paramClass, String paramString, boolean paramBoolean) {
    HashMap<Object, Object> hashMap1 = (HashMap)a.get(paramClass);
    HashMap<Object, Object> hashMap2 = hashMap1;
    if (hashMap1 == null) {
      hashMap2 = new HashMap<Object, Object>();
      a.put(paramClass, hashMap2);
    } 
    ArrayList arrayList = (ArrayList)hashMap2.get(paramString);
    ArrayList<Method> arrayList2 = arrayList;
    if (arrayList == null) {
      Method[] arrayOfMethod2 = methodsMap.get(paramClass);
      ...
      for (int i = 0; i < j; i++) {
        ...
        ArrayList<Method> arrayList4 = (ArrayList)hashMap2.get(str);
        ArrayList<Method> arrayList3 = arrayList4;
        if (arrayList4 == null) {
    ...
    ArrayList<Method> arrayList1 = arrayList2;
    if (arrayList2 == null)
  ...
  public static int javaNew(long paramLong, Class<?> paramClass) {
    synchronized (LuaStateFactory.getExistingState(paramLong)) {
      ...
      if ((paramClass.getModifiers() & 0x400) != 0) {
        ...
        i = javaOverride(paramLong, paramClass);
        return i;
      } 
      i = b(null, paramClass);
      return i;
  ...
  public static int javaOverride(long paramLong, Class<?> paramClass) {
    synchronized (LuaStateFactory.getExistingState(paramLong)) {
      LuaTable<Object, Object> luaTable = new LuaTable<Object, Object>(null, 2);
      null.remove(2);
      if (b(null, (new LuaEnhancer(paramClass)).create(new MethodFilter(luaTable) {
              public boolean filter(Method param1Method, String param1String) {
                return this.a.containsKey(param1String);
              }
            })) == 0)
        return 0; 
  ...
  public static int newArray(long paramLong, Class<?> paramClass) {
    synchronized (LuaStateFactory.getExistingState(paramLong)) {
      ...
      for (int i = 0; i < j; i++)
        arrayOfInt[i] = (int)null.toInteger(i + 2); 
  ...
  public static int objectCall(long paramLong, Object paramObject) {
    synchronized (LuaStateFactory.getExistingState(paramLong)) {
      ...
      if (bool) {
        ...
        while (i <= j) {
          arrayOfObject[i - 2] = null.toJavaObject(i);
          i++;
        } 
  ...
  public static int setArrayValue(long paramLong, Object paramObject, int paramInt) {
    synchronized (LuaStateFactory.getExistingState(paramLong)) {
      if (paramObject.getClass().isArray()) {
        ...
        ((List<Object>)paramObject).set(paramInt, null.toJavaObject(3));
      } else {
        if (paramObject instanceof Map) {
          ((Map<Long, Object>)paramObject).put(Long.valueOf(paramInt), null.toJavaObject(3));
          return 0;
        } 
        StringBuilder stringBuilder = new StringBuilder();
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\luajava\LuaJavaAPI.class
