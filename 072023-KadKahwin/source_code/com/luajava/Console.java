    ...
    try {
      ...
      if (paramArrayOfString.length > 0) {
        for (int i = 0; i < paramArrayOfString.length; i++) {
          int k = luaState.LloadFile(paramArrayOfString[i]);
          int j = k;
          if (k == 0)
...
/* Location:              C:\Users\User\Downloads\Telegram Desktop\Jemputan Majlis Perkahwinan-2\c.jar!\com\luajava\Console.class
